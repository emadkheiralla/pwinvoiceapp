...
@Component({
  selector: 'app-oa-response',
  templateUrl: './oa-response.component.html',
  styleUrls: ['./oa-response.component.css']
})
export class OaResponseComponent {
  private gridApi;
  ...
  constructor() {
    ...
    this.frameworkComponents = {
      ...
      gridViewOAButton: GridOaButtonRendererComponent
    };
  }
